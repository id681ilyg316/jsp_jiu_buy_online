...
public class Info {
	...
	public static String tform(HashMap map)
	{
    	...
    	jscode+="{\n";
    	 ...
    	 while(it.hasNext())
    	 {
    	  ...
    	  jscode+="{\n";
    	  jscode+="document.getElementById(\"txt\").src=\"/jiu_buy_online/upfile/"+map.get("filename")+"\";\n";
    	  jscode+="}\n";
    	 }
    	 jscode+="}\n";
	...
	//System.out.println(a);
	 ...
	 /**
		...
		{
			String jscode = "";
			jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/jiu_buy_online/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
			jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
			jscode+="<script type=\"text/javascript\"  src=\"/jiu_buy_online/js/popup.js\"></script>";
			return jscode;
		}
