								...
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="buttons">
											...
											<a class="btn wishlist" href="/jiu_buy_online/jiu_buy_online?ac=delfav&goodid=<%=goodsmap.get("id") %>&page=favgoods.jsp" title="取消收藏"><span class="glyphicon glyphicon-remove"></span></a>
										</div>
										<div class="caption">
