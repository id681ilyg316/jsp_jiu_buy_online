						    ...
						    <div class="alert alert-info">
						        <button type="button" class="close" data-dismiss="alert">×</button>
						        	...
						        	<script type="text/javascript">
						        		location.href="admin/myaccount.jsp";
						        	</script>
					    	</div>
						<%}%>
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=pwdedit&id=<%=map.get("id") %>" method="post">
		        <label>旧密码</label>
		        ...
		        <label>确认新密码</label>
		        <input type="password"  id="newpwd1" name="newpwd1" class="input-xlarge span12" onblur="validatorpwd()" required>
