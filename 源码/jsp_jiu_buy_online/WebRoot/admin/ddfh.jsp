...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=ddfh&ddid=<%=ddid %>" method="post">
		    	<label>物流公司</label>
		    	<select id="wlcompany" name="wlcompany" required>
		        ...
		        <label>物流单号</label>
		        <input type="text" id="wlno" name="wlno" class="input-xlarge span12" required>
		        <button class="btn btn-primary"><i class="icon-save"></i> 发货</button>
		    </form>
      </div>
  </div>
