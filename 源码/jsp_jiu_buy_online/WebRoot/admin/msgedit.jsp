...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=msghf&id=<%=id %>" method="post">
		        <label>回复内容</label>
		        <input type="text" id="hfmsg" name="hfmsg" class="input-xlarge span12" value="<%=map.get("msghf") %>" required>
