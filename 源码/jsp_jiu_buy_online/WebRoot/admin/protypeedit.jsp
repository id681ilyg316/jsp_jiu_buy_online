...
<html lang="en">
  ...
  HashMap map = dao.select("select * from protype where id="+id).get(0);
  %>
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=protypeedit&id=<%=id %>" method="post">
		        <label>类别名称</label>
		        <input type="text" id="title" name="typename" class="input-xlarge span12" value="<%=map.get("typename") %>" required>
