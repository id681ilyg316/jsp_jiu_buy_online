...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=useredit&id=<%=id %>" method="post">
		        <label>用户名</label>
		        <input type="text" value="<%=map.get("username") %>" id="username" name="username" class="input-xlarge span12" readonly="readonly" required>
		        <label>密码</label>
