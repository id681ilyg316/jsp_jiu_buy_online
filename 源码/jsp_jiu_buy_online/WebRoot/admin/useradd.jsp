...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=useradd" method="post">
		        <label>用户名</label>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function validatorloginName(){     
       	 ...
       	 $.ajax({  
       	        type: "POST",      
       	         url: "/jiu_buy_online/jiu_buy_online?ac=usernamecheck", //servlet的名字     
