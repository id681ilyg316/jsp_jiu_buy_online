...
<html lang="en">
  ...
  HashMap map = dao.select("select * from pj where id="+id).get(0);
  %>
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=pjhf&id=<%=id %>&gid=<%=gid %>" method="post">
		        <label>回复内容</label>
		        <input type="text" id="hf" name="hf" class="input-xlarge span12" required>
