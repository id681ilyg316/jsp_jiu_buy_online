...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/jiu_buy_online/jiu_buy_online?ac=yqlinkedit&id=<%=id %>" method="post">
		        <label>链接名称</label>
		        <input type="text" id="title" name="linkname" class="input-xlarge span12" value="<%=map.get("linkname") %>" required>
		        <label>链接地址</label>
		        <input type="text" id="title" name="linkurl" class="input-xlarge span12" value="<%=map.get("linkurl") %>" required>
