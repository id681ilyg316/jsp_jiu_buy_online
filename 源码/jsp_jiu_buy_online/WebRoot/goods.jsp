							...
							<%
								...
								<li class="lm-imgItem">
					                ...
					                <div class="buttons">
											...
											<a class="btn wishlist" href="/jiu_buy_online/jiu_buy_online?ac=addfav&goodid=<%=goodsmap.get("id") %>&page=index.jsp" title="收藏此商品"><span class="glyphicon glyphicon-heart"></span></a>
								    </div>
								    <div class="caption">
...
function tocar(gid){     
	 $.ajax({  
	        type: "POST",      
	         url: "/jiu_buy_online/jiu_buy_online?ac=tocar", //servlet的名字     
	          data: "gid="+gid+"&sl=1", 
