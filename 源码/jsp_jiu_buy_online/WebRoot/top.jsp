			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="/jiu_buy_online/admin" target="_blank" ><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
						<%
							} else {
						%>
						<li><a href="#" role="button" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1"
									href="/jiu_buy_online/jiu_buy_online?ac=frontexit"><i
										class="glyphicon glyphicon-log-out"></i>安全退出</a>
								</li>
								<li><a target="_blank" href="/jiu_buy_online/admin"><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
							</ul></li>
						<%
