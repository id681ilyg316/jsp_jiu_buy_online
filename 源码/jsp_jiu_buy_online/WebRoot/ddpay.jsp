		...
		<div class="container">
			...
			<div class="info">支付金额：	<%=ddprice %> 元</div>
						...
						<div class="tab-content" id="tags">
							...
							<form name="form1" id="ff1" action="/jiu_buy_online/jiu_buy_online?ac=pay&ddid=<%=ddid %>">
							...
							<div id="tagContent1" class="tab-pane fade">
							  <form name="form2" id="ff2" action="/jiu_buy_online/jiu_buy_online?ac=pay&ddid=<%=ddid %>">
								<div class="form-group">
