  ...
  HashMap member = dao.select("select * from member where id="+membersession.get("id")).get(0); %>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			ArrayList<HashMap> goodlist = (ArrayList<HashMap>)dao.select("select *,a.id as aid,b.id as bid from car a,goods b where a.gid=b.id and a.mid='"+member.get("id")+"' and b.delstatus='0' order by aid desc");
...
<script type="text/javascript">
	...
	function updatecar(i){
		...
		if(sl==""||sl<=0){
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/jiu_buy_online/jiu_buy_online?ac=updatecart", //servlet的名字     
	...
	function updatetprice(){
		$.ajax({  
	        type: "POST",      
	         url: "/jiu_buy_online/jiu_buy_online?ac=updatetprice", //servlet的名字     
	          data: "", 
	         success: function(data){       
	    if(data!=null){     
	    	$("#dprice").html(data);
